//! Phase 3 end-to-end test: index a 10-file fixture, search, assert
//! known queries return known files at known ranks. This is the spec
//! check from `phase.md` § Phase 3 — Tests.
...
async fn bm25_score_monotonicity_under_term_repetition() {
    // phase.md: doubling a term frequency in a doc raises that doc's
