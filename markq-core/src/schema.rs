//! Arrow schema for the chunk table — designed once in Phase 1 to its final
//! v1.5 shape so adding `markq context add` (Phase 11) and multi-collection
//! routing (Phase 10) is additive rather than a Lance migration + full
//! re-embed.
//!
...
pub fn chunk_arrow_schema(embedding_dim: i32) -> SchemaRef {
    Arc::new(Schema::new(vec![
        ...
        // Routing column for `-c <name>` filter pushdown (Phase 10).
        ...
        // Reserved here so context-tree prefix matching (Phase 11) is a
        ...
        // reindex (Phase 8): unchanged hash → skip the file entirely.
        ...
        // The chunk's text. BM25 (Phase 3) indexes this column.
        ...
        // Vector embedding. Nullable until Phase 4. Fixed-size list keeps
        ...
        // Reserved for Phase 11 context tree. Nullable until then; populated
