//! Edge-case tests for the Phase 2 chunker.
//!
//! These run against synthetic fixtures embedded in the test source rather
//! than disk fixtures. The Phase 0c `corpus/` directory will be wired in as
//! a separate evaluation harness during Phase 5 (per
