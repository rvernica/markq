...
//! shape is single-owner thread + message passing. Future reranker (Phase 6)
//! and HyDE generator (Phase 13) copy this exact shape.
//!
...
mod tests {
    ...
    // worth the scaffolding for a single phase. See plan.md verification
